...
{
	public class WeaponSpeedIncreaseTarget : Target // Create our targeting class (which we derive from the base target class)
	{
		...
		protected override void OnTarget( Mobile from, object target ) // Override the protected OnTarget() for our feature
		{
			...
			if ( target is BaseJewel )
			{
				...
				from.SendMessage( "You increase the items weapon speed... at a cost." );
			...
			{
				from.SendMessage( "You can only add weapon speed to jewelry or weapons" );
			}
		}
	}

	public class WeaponSpeedIncreaseDeed : Item // Create the item class which is derived from the base item class
	{
        private int m_level;
		...
		public override void OnDoubleClick( Mobile from ) // Override double click of the deed to call our target
		{
			...
			else
			{
                ...
                from.Target = new WeaponSpeedIncreaseTarget( this ); // Call our target
			 }
		}	
	}
}