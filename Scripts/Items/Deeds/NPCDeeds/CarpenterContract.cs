...
{
	public class CarpenterContract : Item
	{
		public override string DefaultName
		{
			get { return "an carpenter contract"; }
		}

		[Constructable]
		public CarpenterContract() : base( 0x14F0 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public CarpenterContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new PlayerCarpenter( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new PlayerCarpenter( from, house );
