...
{
	public class ProvisionerContract : Item
	{
		public override string DefaultName
		{
			get { return "an provisioner contract"; }
		}

		[Constructable]
		public ProvisionerContract() : base( 0x14F0 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public ProvisionerContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new PlayerProvisioner( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new PlayerProvisioner( from, house );
