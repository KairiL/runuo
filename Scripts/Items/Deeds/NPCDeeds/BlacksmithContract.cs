...
{
	public class BlacksmithContract : Item
	{
		public override string DefaultName
		{
			get { return "an blacksmith contract"; }
		}

		[Constructable]
		public BlacksmithContract() : base( 0x14F0 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public BlacksmithContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new PlayerBlacksmith( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new PlayerBlacksmith( from, house );
