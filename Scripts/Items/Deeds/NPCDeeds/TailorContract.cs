...
{
	public class TailorContract : Item
	{
		public override string DefaultName
		{
			get { return "an tailor contract"; }
		}

		[Constructable]
		public TailorContract() : base( 0x14F0 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public TailorContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new PlayerTailor( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new PlayerTailor( from, house );
