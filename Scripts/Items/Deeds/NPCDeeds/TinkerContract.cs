...
{
	public class TinkerContract : Item
	{
		public override string DefaultName
		{
			get { return "an tinker contract"; }
		}

		[Constructable]
		public TinkerContract() : base( 0x14F0 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public TinkerContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new PlayerTinker( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new PlayerTinker( from, house );
