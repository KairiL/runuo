...
{
	public class AnimalTrainerContract : Item
	{
		public override string DefaultName
		{
			get { return "an animal trainer contract"; }
		}

		[Constructable]
		public AnimalTrainerContract() : base( 0x14F0 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public AnimalTrainerContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new PlayerAnimalTrainer( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new PlayerAnimalTrainer( from, house );
