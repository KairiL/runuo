...
namespace Server.Items
{
	...
	public class PMList
	{
		...
		public static readonly PMList[] UORLists		= new PMList[] { Felucca };//removed Trammel
		public static readonly PMList[] UORListsYoung	= new PMList[] { Felucca };//changed Trammel to Felucca
		public static readonly PMList[] LBRLists		= new PMList[] { Felucca, Ilshenar };//removed Trammel
        public static readonly PMList[] LBRListsYoung	= new PMList[] { Felucca, Ilshenar };//changed Trammel to Felucca
        public static readonly PMList[] AOSLists		= new PMList[] { Felucca, Ilshenar, Malas };//removed Trammel
        public static readonly PMList[] AOSListsYoung	= new PMList[] { Felucca, Ilshenar, Malas };//Changed Trammel to Felucca
		public static readonly PMList[] SELists			= new PMList[] { Felucca, Ilshenar, Malas, Tokuno };//removed Trammel
        public static readonly PMList[] SEListsYoung	= new PMList[] { Felucca, Ilshenar, Malas, Tokuno };//changed Trammel to Felucca
		public static readonly PMList[] RedLists		= new PMList[] { Felucca };//added Ilshenar, Malas, Tokuno
