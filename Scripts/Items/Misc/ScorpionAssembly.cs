...
{
	public class ScorpionAssembly : Item
	{
		
		[Constructable]
		public ScorpionAssembly() : base( 0x1EA8 )
		{
			Weight = 5.0;
			Hue = 1102;
		...
		public ScorpionAssembly( Serial serial ) : base( serial )
		{
		}
		...
		{
			private ScorpionAssembly m_ass;

			public IngotTarget( ScorpionAssembly ass ) : base( 2, false, TargetFlags.None )
			{
			m_ass = ass;
			}
			...
			{   
				...
				switch ( res )
				{
                    ...
                    default:
					{
						Golem g = new GolemScorpion( 1, scalar, metal );
